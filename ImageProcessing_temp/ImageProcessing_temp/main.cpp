...
void writeFile(IplImage* img, char* imgFilename, const char* addName) {
    ...
    *ext_p = '\0';   // ファイル名から拡張子を消す
    sprintf_s(filename, 255, "%s+%s(%dx%d).bmp", filename, addName, OPE_SIZE * 2 + 1, OPE_SIZE * 2 + 1); // ノイズ名を付加したファイル名を生成
...
void main(int argc, char* argv[])
{
    ...
    */
    ...
    char fn[] = "C:/Users/hotar/Documents/Git/ImageProcessing/SampleImage/color/Parrots+Salt&PepperNoise.bmp"; // Drag&Dropで処理する場合は　②ここをコメントアウトする
